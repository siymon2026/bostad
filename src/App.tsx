...
const projectData = [
  { image: '/assets/portfolio/project-1.jpg', client: 'Dar Atlas', category: 'Branding', tags: ['Branding'], desc: 'Restaurant identity & launch campaign' },
  { image: '/assets/portfolio/project-2.jpg', client: 'Naya Skin', category: 'Social Media / Ads', tags: ['Social Media', 'Ads'], desc: 'Content direction & paid social' },
  { image: '/assets/portfolio/project-3.jpg', client: 'Rif Roasters', category: 'Content', tags: ['Content', 'Branding'], desc: 'Brand system & product storytelling' },
  { image: '/assets/portfolio/project-4.jpg', client: 'NOOR Studio', category: 'Websites', tags: ['Websites'], desc: 'E-commerce experience & campaign' },
];

function Logo({ light = false }: { light?: boolean }) {
  const [missing, setMissing] = useState(false);
  return <a href="#home" className={`brand ${light ? 'brand-light' : ''}`} aria-label="Boostad - Home">
    {!missing && <img src="/assets/logo.png" alt="Boostad Marketing Agency" onError={() => setMissing(true)} />}
